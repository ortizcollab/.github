# Software Charter for Ortiz Collaborative 

## 1. Definition

This is the software charter for Ortiz Collaborative (the "Organization"). By adding their name to the [Steering Committee.md file](./STEERING-COMMITTEE.md), Steering Committee members agree as follows.
